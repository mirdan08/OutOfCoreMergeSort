...
input_file = "mpi_weak_bigpayloads.out"
output_file = "mpi_weak_averaged_results_bigpayloads.csv"
...
result_rows = []
group_cols = ["num_threads", "max_payload_size", "records_number",'num_nodes']
