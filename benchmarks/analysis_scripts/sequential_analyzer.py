...
input_file = "result_seq_ooc.out"
output_file = "sequential_averaged_results.csv"
...
result_rows = []
group_cols = ["max_payload_size", "records_number"]
...
for group_keys, group_df in df.groupby(group_cols):
    ...
    result_rows.append({
        "max_payload_size": group_keys[0],
        "records_number": group_keys[1],
